...
<body id="page-top">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(product_id) as jumlah_prod from fact_product";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(p.product_id) as jml_product FROM fact_product p
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    <?php  
                                                    $sql = "SELECT COUNT(p.product_id) as jml_prd2 FROM fact_product p
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.date), ' ', YEAR(t.date)) month FROM fact_product f 
                  JOIN time t ON f.time_id=t.time_id GROUP BY t.month 
                  ORDER BY t.date";
        $product = "SELECT COUNT(f.product_id) product FROM fact_product f 
                    JOIN times t ON f.time_id=t.time_id GROUP BY t.month 
                    ORDER BY t.date";
        $i=1;
