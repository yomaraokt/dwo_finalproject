...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(c.customer_id) as jml_ct1 FROM fact_sales c
                                                    JOIN time t ON c.time_id=t.time_id 
                                                    WHERE t.year=2004";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['jml_ct1'],0,".",",");
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.date), ' ', YEAR(t.date)) month FROM fact_sales f 
                  ...
                  ORDER BY t.date";
        $product = "SELECT COUNT(s.customer_id) as customer FROM fact_sales s
